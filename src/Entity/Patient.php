 ...
 * @UniqueEntity(fields={"ID_patient"}, message="There is already an account with this ID_patient")
 */
class Patient implements UserInterface
{
     ...
     * @var string
     *
     * @ORM\Column(name="adresseMail", type="string", length=50, nullable=false , unique=true)
     */
    private $adressemail;
