 ...
 * Commande
 *
 * @ORM\Table(name="commande", indexes={@ORM\Index(name="ID_patient", columns={"idpanier"}), @ORM\Index(name="fkIdPatient", columns={"IdPatient"}), @ORM\Index(name="idlivreur", columns={"idlivreur"})})
...
class Commande
{
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="idlivreur", referencedColumnName="id_livreur")
     * })
     */
    private $idlivreur;
    ...
    public function setIdCommande(? idCommande $idCommande): void
    {
