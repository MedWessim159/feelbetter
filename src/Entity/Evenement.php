...
class Evenement
{
     ...
     * @Assert\Length(
     *     min = 5,
     *     minMessage=" Entrer un titre au mini de 5 caractères "
     * )
     ...
     * @Assert\GreaterThanOrEqual("today",message="La date doit être supérieure à la date  d'aujourd'hui!"))
     */
    private $date;
     ...
     * @Assert\NotBlank(message="Entrer votre description!")
     * @Assert\Length(
     *     min=7,
     *     max=255,
     *     minMessage="votre description est trop court ",
     *     maxMessage="votre description est trop long ")
     */
     ...
     * @Assert\NotBlank(message="Entrer votre prix!")
     */
    private $prixEvent;
